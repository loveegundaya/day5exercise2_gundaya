		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment and Internalization",
									"targetURL": "#zbtpday5exercise2gundaya-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbtpday5exercise2gundaya-display": {
								"semanticObject": "zbtpday5exercise2gundaya",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbtp.day5exercise2gundaya",
									"url": sap.ui.require.toUrl("zbtp/day5exercise2gundaya")
								}
							}
						}
					}
